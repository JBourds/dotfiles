...
ENCRYPTION_PIPE = ["gpg", "--encrypt", "--recipient", "jordanbourdeau03@outlook.com"]
...
registrations = {
    ...
    "uvm": {
        "authorize_endpoint": "https://login.microsoftonline.com/login.srf",
